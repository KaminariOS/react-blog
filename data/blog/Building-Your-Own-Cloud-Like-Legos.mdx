...
There is also a self-hosted tailscale alternative Headscale.
...
With cloudflared as the entrypoint to your cluster services, you do not actually need a reverse proxy like Traefik or Nginx.

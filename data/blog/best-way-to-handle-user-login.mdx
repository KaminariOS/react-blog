...
draft: false
summary: "Exploring modern authentication strategies for public-facing apps — from passwords to passkeys, and how to unify them securely."
---
...
✅ **Phishing-resistant** — users can’t be tricked into fake domains(WebAuth enforces HTTPS). 
...
- **[Kanidm](https://kanidm.com/)**(Rust) — an identity management system with built-in WebAuthn and OIDC support.  
- **[Pocket-ID](https://pocket-id.app/)**(Go) — a lightweight self-hosted OIDC provider supporting passkeys and OAuth.
